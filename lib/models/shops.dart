...
class Shop {
  ...
  static List<Shop> shopList = [
    ...
    Shop(icon: Icons.phone, title: 'Jamii Telecom', subtitle: 'Ketty Plaza, Mombasa'),
    Shop(icon: Icons.phone, title: 'Jamii Telecom', subtitle: 'Hurligham, UON pension'),
    ...
    Shop(icon: Icons.phone, title: 'Fortress international', subtitle: 'Galleria/Valley Arcade'),
    ...
    Shop(title: 'Tuscom Green Square', subtitle: 'Inside Tuskys Green Square kericho'),
  ];
}
